      ...
      <Container>
        <Row>
          <Col sm={6} className="py-4">
            <small>
              Dbcrul - application scaffolding by <a href="http://softwaremill.com">SoftwareMill</a>, sources
              available on <a href="https://github.com/softwaremill/dbcrul/">GitHub</a>
            </small>
          </Col>
